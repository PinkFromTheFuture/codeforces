...
# then he is a male, otherwise she is a female. You are given the string that denotes
...
# use set to remove duplicates and then len to count the remaining letters
distinct_characters_count = len(set(user_name))
...
if distinct_characters_count%2==0:
    print("CHAT WITH HER!")
else:
    print("IGNORE HIM!")
