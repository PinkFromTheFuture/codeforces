...
instructions_that_print_something = 'HQ9'
will_produce_any_output_flag = False

for char in p:
    if char in instructions_that_print_something:
        will_produce_any_output_flag = True
        # we found what we were looking for, so no more need to keep looping
        break

# Output
# Output "YES", if executing the program will produce any output, and "NO" otherwise.
if will_produce_any_output_flag:
    print('YES')
else:
    print('NO')
