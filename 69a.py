...
# determines whether a body is idle or is moving by the given vectors of forces
if sum(x) == 0 and sum(y) == 0 and sum(z) == 0:
    the_body_is_in_equilibrium = True
else:
    the_body_is_in_equilibrium = False

# Output
# Print the word "YES" if the body is in equilibrium, or the word "NO" if it is not.
if the_body_is_in_equilibrium:
    print('YES')
else:
    print('NO')